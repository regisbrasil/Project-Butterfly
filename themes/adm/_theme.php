...
<body>
  ...
  <nav class="navbar col-12 m-auto navbar-dark bg-dark fixed-top mb-5">
          ...
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark">
                ...
                <li><a class="dropdown-item" href="<?= url("admin/faq-registro"); ?>">Nova Faq</a></li>
              </ul>
            </li>
            <li class="nav-item"><a class="nav-link" href="<?= url("admin/usuarios"); ?>">Lista de Usuário</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= url("admin/postagens"); ?>">Lista de Postagens</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= url("admin/faqs"); ?>">Lista de FAQs</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= url("admin/sair"); ?>">Sair da conta</a></li>
          </ul>
        </div>
      </div>
    </div>
