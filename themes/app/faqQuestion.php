...
<body>
    ...
    <div class="register">
        ...
        <h1 class="text-center">Alguma Duvída?</h1>
        
        <form id="form-register-faq" class="needs-validation" novalidate>
            <div class="form-group">
                <label class="form-label">Pergunta:</label>
                <input type="text" name="question" class="form-control" id="question" value="Minha vida faz sentido?">
            </div>
    ...
    <script type="text/javascript" async>
        ...
        form.addEventListener("submit", async (e) => {
            ...
            const data = await fetch("<?= url("app/nova-pergunta"); ?>",{
                method: "POST",
                body: dataFaq
            });
            ...
            if(faq){
                window.location.href = "http://www.localhost/projpwii/app/faq";
            }
             if(faq.type) {
